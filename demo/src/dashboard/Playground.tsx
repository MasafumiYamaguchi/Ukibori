...
/**
 * #21 React API Playground (moved out of App.tsx so the dashboard shell can
 * mount it exclusively). The physical renderer is driven through <Ukibori> /
 * <Surface> / <UkiboriText>. The DOM stays authoritative (real buttons, DOM
 * text); the physical layer (SDF -> height field -> material lighting + cast
 * shadows) renders onto the provider's stage-root overlay.
 *
 * Every control from the original single-page demo is preserved: backend,
 * light axes/color/intensity, soft-shadow samples and angular radius,
 * raw/reconstructed shadow view and reconstruction radius, environment,
 * environment specular share, exposure, elevation, thickness, radius,
 * material, emissive intensity, nearby emissive light and bloom, the real
 * buttons/input and the PLAY glyph.
 */
